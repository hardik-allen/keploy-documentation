      ...
      <div className="w-full">
        <div className="flex h-14 sm:h-16 items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* GitHub link */}
            <a
              href="https://github.com/keploy/docs"
              target="_blank"
              rel="noopener noreferrer"
              className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-lg border border-zinc-200 bg-white text-zinc-600 transition-colors hover:bg-zinc-50 hover:text-zinc-900 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700 dark:hover:text-zinc-100 flex-shrink-0"
              aria-label="GitHub"
            >
